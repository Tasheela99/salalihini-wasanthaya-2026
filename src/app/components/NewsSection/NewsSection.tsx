import { faComment, faFilm, faPen } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className={styles.grid}>
                ...
                <div key={item.title} className={styles.newsItem}>
                  ...
                  <div className={styles.newsInfo}>
                    ...
                    <p className={styles.newsMeta}>
                      <FontAwesomeIcon icon={faComment} /> {item.comments} &nbsp;<FontAwesomeIcon icon={faPen} /> {item.author}
                    </p>
                  </div>
                </div>
              ))}
          ...
          <div className={styles.column}>
            ...
            <div className={styles.campaignPlaceholder}>
              <span><FontAwesomeIcon icon={faFilm} /> Campaign Video</span>
            </div>
