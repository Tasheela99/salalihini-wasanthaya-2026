...
export default function AboutPage() {
  return (
    <div className="container" style={{ paddingTop: "3rem",paddingBottom:"3rem" }}>
      <SectionLabel label="ABOUT FESTIVAL" />
      <section className={styles.eventSection}>
        <p className={styles.eventIntro}>
          සැලළිහිනි වසන්තය is an annual national cultural extravaganza organized
          by Sri Lanka Rupavahini Corporation in the picturesque hill country of
          Nuwara Eliya. This celebration promotes Sri Lankan tourism,
          traditional arts, and the beauty of the spring season, attracting
        ...
        <div className={styles.festivalGrid}>
          ...
          <div className={styles.festivalCard}>
            ...
            <p>
              Live performances by Sri Lanka&apos;s finest artists, celebrating
